...
public class EsqueletoLider extends TemplateEnemy {
    ...
    public EsqueletoLider(int x, int y, int ancho, int altura, String nombre, int vidaMax, int dano, int velocidad,
        ...
        builder.addImage(9, 4);
        builder.addImage(10, 4);
        builder.addImage(11, 4);
        ...
        builder.addImage(9, 5);
        builder.addImage(10, 5);
        builder.addImage(11, 5);
        ...
        builder = new image.SpriteBuilder(Assets.zombieEsqueletoSheet,96,96);
        builder.addImage(9, 6);
        builder.addImage(10, 6);
        builder.addImage(11, 6);
        ...
        builder = new image.SpriteBuilder(Assets.zombieEsqueletoSheet,96,96);
        builder.addImage(9, 7);
        builder.addImage(10, 7);
        builder.addImage(11, 7);
    ...
    ActionListener tirarHueso = new ActionListener(){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            handler.agregarObjeto(new BalaEnemigo(x,y,destinoX + ran.nextInt(160) + 30,destinoY + ran.nextInt(160) + 30,getAngulo(new Point(destinoX,destinoY)),handler,main));
            handler.agregarObjeto(new BalaEnemigo(x,y,destinoX - ran.nextInt(160) + 30,destinoY - ran.nextInt(160) + 30,getAngulo(new Point(destinoX,destinoY)),handler,main));
