	...
	public void crear() {
		...
		while(i < 3)
		{
			...
			else
			{
				...
				else if(tipoEnemigo > 50 && tipoEnemigo <= 80)
					Game.getHandler().agregarObjeto(new Esqueleto(x * 80,y * 80,40,40,"Esqueleto",100,5,8,Game.getHandler(),game));
				else
					Game.getHandler().agregarObjeto(new Fantasma(x * 80,y * 80,30,30,"Fantasma",100,5,8,Game.getHandler(),game));
